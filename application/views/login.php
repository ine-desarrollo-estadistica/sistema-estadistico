...
<head>
	...
	<meta charset="UTF-8" />
	<link rel="stylesheet" type="text/css" href="<?php echo "http://localhost/CensoRRHH/";  ?>theme/css/bootstrap.css" />
	...
	<div class="container">
		<div class="row-fluid">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				<h1 class="text-center login-title">Censo de Recurso Humano - INE</h1>
