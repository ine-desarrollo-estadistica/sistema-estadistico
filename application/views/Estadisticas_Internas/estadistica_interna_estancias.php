...
<script type="text/javascript">
    $(document).ready(function() {
        $('#dep_cod').multiselect({includeSelectAllOption: true});
    });
</script>
...
<div class="container"><!--Abrir Container-->
    ...
    <div class="container text-center">
      <h3  class="text-info">FICHA DE ESTANCIAS <small> -Estadisticas Hospitalarias Servicios Internos- </small></h3> <!--Titulo de la Vista --> 
    </div>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body" style="text-align: center;">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                 <label for="edad_cod">Rango de Departamentos:</label>
                       <select class="form-control text-capitalize" name="departamento[]" id="dep_cod" multiple="multiple" required>
                            <?php
    ...
    <table id="maestros" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                                        <th>Periodo</th>
                                        <th>Departamento</th>
                                        <th>Pacientes Egresados</th>
                                        <th>Promedio de estancias</th>
        ...
        <tbody>
            <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['Departamento_Residencia']; ?></td>                       
                                        <td><?php echo number_format($row['Pacientes_Egresados'], 0); ?></td>
                                        <td><?php echo number_format($row['Promedio_Estancia'], 2); ?></td>
