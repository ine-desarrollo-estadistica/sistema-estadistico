...
<div class="container"><!--Abrir Container-->
    ...
    <div class="container text-center">
      <h3  class="text-info">TOTAL POR DEPARTAMENTOS POR CAUSA DE ATENCIÓN Y SEXO<small> -Estadisticas Hospitalarias Servicios Internos- </small></h3> <!--Titulo de la Vista --> 
    </div>
        ...
        <tbody>
            <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['codigo_cie_10']; ?></td>
                                        <td><?php echo $row['causa']; ?></td>
                                        <td><?php echo number_format($row['sexo_m'], 0); ?></td>
                                        <td><?php echo number_format($row['sexo_f'], 0); ?></td>
