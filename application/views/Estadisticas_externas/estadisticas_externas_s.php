...
<div class="container"><!--Abrir Container-->
    ...
    <div class="container text-center">
      <h3  class="text-info">Atenciones en los servicios externos por tipo de consulta, sexo y edad <small> -Estadisticas Hospitalarias Servicios Externos- </small></h3> <!--Titulo de la Vista --> 
    </div>
        ...
        <tbody>
            <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['Periodo_edad']; ?></td>
                                        <td><?php echo $row['Sexo']; ?></td>
                                        <td><?php echo number_format($row['primera_consulta'], 0); ?></td>
                                        <td><?php echo number_format($row['reconsulta'], 0); ?></td>
                                        <td><?php echo number_format($row['emergencia'], 0); ?></td>
