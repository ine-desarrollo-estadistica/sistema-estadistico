...
<div class="container"><!--Abrir Container-->
    ...
    <div class="container text-center">
      <h3  class="text-info">Atenciones en los servicios externos según departamento de residencia , causas de atención y sexo <small> -Estadisticas Hospitalarias Servicios Externos- </small></h3> <!--Titulo de la Vista --> 
    </div>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body" style="text-align: center;">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                 <label for="dep_cod">Rango de Departamentos:</label>
